...
public:
    ...
    void set_paged_state(bool paged_state){ paginacion = paged_state;}

    bool get_paged_state(){return paginacion;}

    void set_songs_file(Data* songs_file){carpeta_de_canciones = songs_file;}

    Data* get_songs_file(){return carpeta_de_canciones}

    void set_playlist_state(bool state){active_playlist = state;}
